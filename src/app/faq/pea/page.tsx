  ...
  return (
    <>
      ...
      <PageHero
        ...
        titre={<>Questions fréquentes<br />PEA (Plan d&apos;Épargne en Actions)</>}
        description="Plafond, fiscalité après 5 ans, prélèvements sociaux, passif fiscal latent, succession. Réponses factuelles avec références au CGI."
      />
          ...
          <header className="mb-12">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium mb-1 text-neutral-400">Calculateur PEA</div>
