      ...
      <main style={{ backgroundColor: '#F7F3EC' }}>
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <header className="mb-12">
            <Link href="/lmnp-reel-vs-micro" className="block bg-neutral-900 text-white rounded-xl p-6 hover:bg-neutral-800 transition-colors group">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-sm font-medium mb-1 text-neutral-400">Calculateur LMNP</div>
