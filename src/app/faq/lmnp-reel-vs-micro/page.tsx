        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <header className="mb-12">
            <nav className="flex items-center gap-2 font-mono text-xs text-neutral-400 mb-8">
              ...
              <span>/</span>
              <span className="text-neutral-600">LMNP réel vs micro</span>
            </nav>

            <div className="h-[2px] w-10 bg-accent-400 mb-6" />

            <h1 className="font-serif text-4xl font-bold text-neutral-900 mb-4">
              Questions fréquentes<br />LMNP : réel vs micro-BIC
            </h1>
            <p className="text-lg text-neutral-600 max-w-2xl mb-10">
              Seuils LF 2025, charges déductibles, amortissements, déficit non imputable,
              réintégration à la sortie.
            </p>
