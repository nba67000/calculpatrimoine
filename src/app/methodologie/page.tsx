...
export default function Methodologie() {
 ...
 <div>
 <div className="font-semibold text-primary-700 mb-1">Femmes</div>
 <ul className="space-y-1 text-neutral-700">
 ...
 <p className="text-sm font-semibold text-primary-700 mb-2">Exemple concret</p>
 ...
 <div className="p-4 bg-primary-50 rounded-lg">
 <div className="font-semibold text-primary-700 mb-2">Femmes</div>
 <p className="text-sm text-primary-700">
